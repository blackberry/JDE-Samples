 ...
 */
class TextComponent extends Field implements AccessibleContext, AccessibleText {
     ...
     */
    private static class TextComponentStringTokenizer {
         ...
         */
        TextComponentStringTokenizer(final String str) {
            // Initialize members
            _currentPosition = 0;
            _newPosition = -1;
            _str = str;
