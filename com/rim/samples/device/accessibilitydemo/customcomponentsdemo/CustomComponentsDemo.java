 ...
 */
class CustomComponentsDemo extends UiApplication {
    ...
    public static void main(final String[] args) {
        // Construct a new instance of the CustomComponentsDemo and start its
        // event thread
        new CustomComponentsDemo().enterEventDispatcher();
    }

    // Constructor
    private CustomComponentsDemo() {
        try {
     ...
     */
    static class CustomComponentsDemoScreen extends MainScreen {
