 ...
 */
class IconToolbarComponent extends Field implements AccessibleContext {
     ...
     *            The icon label
     */
    public void addIcon(final Bitmap image, final String label) {
    ...
    public class Icon implements AccessibleContext {
         ...
         */
        public void focusChanged(final boolean focusGained) {
            // Update state
