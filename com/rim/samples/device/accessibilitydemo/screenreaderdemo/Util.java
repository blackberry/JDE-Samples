...
public final class Util {
     ...
     */
    public static boolean hasTransitionedToState(final int oldStateSet,
     ...
     */
    public static boolean hasTransitionedFromState(final int oldStateSet,
            final int newStateSet, final int stateFlag) {
        return (~newStateSet & oldStateSet & stateFlag) != 0;
    }
     ...
     */
    public static String getDateSubfieldString(final int subFieldType) {
        switch (subFieldType) {
