...
/**
 * A manager class to contain the SVG map.
 */
public final class SVGMapManager extends VerticalFieldManager {
     ...
     * 
     * @return True if the map manager is panning, false otherwise
     */
    boolean isPanning() {
        return _isPanning;
    }
