...
public final class SendNonBlockAtomScreen extends MainScreen {
    ...
    private static final class SendNonBlockAtomScreenCallback extends
            ResponseCallback {

        private final SendNonBlockAtomScreen _screen;

        private SendNonBlockAtomScreenCallback(
                final SendNonBlockAtomScreen screen) {
            _screen = screen;
        }
