...
/**
 * VirtualTargetListener class for NDEF Tags that are being emulated
 */
public class VirtualNDEFTagListener implements VirtualNDEFTagCallback {
    private final NFCEmulatorScreen _screen;

    /**
     * Creates a new VirtualNDEFTagListener object
     * 
     * @param screen
     ...
     *             if screen == null
     */
    public VirtualNDEFTagListener(final NFCEmulatorScreen screen) {
        if (screen == null) {
    ...
    /**
     * @see net.rim.device.api.io.nfc.emulation.VirtualNDEFTagCallback#onVirtualTargetEvent(int)
     */
    public void onVirtualTargetEvent(final int targetEvent) {
        ...
        case VirtualNDEFTagCallback.READER_LEFT:
            _screen.setEmulationListenerStatus("The reader has left!");
            break;
        case VirtualNDEFTagCallback.SELECTED:
            _screen.setEmulationListenerStatus("Tag has been selected!");
            break;
        case VirtualNDEFTagCallback.TARGET_READ:
            _screen.setEmulationListenerStatus("Tag is being read!");
            break;
        case VirtualNDEFTagCallback.TARGET_UPDATED:
            _screen.setEmulationListenerStatus("Tag has been updated!");
            break;
        case VirtualNDEFTagCallback.EMULATION_STOPPED:
            _screen.setTagStatus("NDEF emulation has stopped");
            break;
        }
    }
}
