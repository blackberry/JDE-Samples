...
package com.rim.samples.device.browser.browserfield2demo;
...
public class BrowserFieldScreen extends MainScreen {
    ...
    private class DemoBrowserListener extends BrowserFieldListener {
         ...
         *      Document)
         */
        public void documentLoaded(final BrowserField browserField,
        ...
        public ScriptableMenuItem(final String label,
            ...
            this.setCommand(new Command(new CommandHandler() {
                ...
                public void execute(final ReadOnlyCommandMetadata metadata,
                    ...
                    new ScriptableMenuItemRunnable().run();
                }
            }));
        }

        private class ScriptableMenuItemRunnable implements Runnable {
