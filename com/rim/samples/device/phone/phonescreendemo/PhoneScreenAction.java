...
public final class PhoneScreenAction extends AbstractPhoneListener {
     ...
     */
    public PhoneScreenAction(final Application app) {
        _app = app;
    }
    ...
    private void sendPhoneScreenData(final int callid) {
        ...
        if (phoneCall != null) {
            ...
            if (phoneNumber.equals("5550111")) {
                ...
                final PhoneScreenHorizontalManager phoneScreenHorizontalManager1 =
                ...
                final PhoneScreenVerticalManager phoneScreenVerticalManager =
                        new PhoneScreenVerticalManager();
                phoneScreenVerticalManager.add(new LabelField(
                        "Location: Waterloo, Ontario"));
                phoneScreenVerticalManager.add(new LabelField("Symbol: RIMM"));

                // Create a PhoneScreenHorizontalManager, set padding and
                // add the PhoneScreenVerticalManager.
                final PhoneScreenHorizontalManager phoneScreenHorizontalManager2 =
                        new PhoneScreenHorizontalManager();
