...
/**
 * Persistent content listener for the BlackBerry Balance Demo app. Listens for
...
public final class PersistentStoreListener implements PersistentContentListener {
     ...
     * because data is always encoded inside the Memo objects. Thus, there is no
     * need to encode or decode them during locking and unlocking.
     * 
     * @param state
