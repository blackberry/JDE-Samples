...
/**
 * This class defines the keycode constants for the various media keys
...
public class MediaKeysMIDletConstants {
    ...
    public static final int PLAY = -273;
    public static final int FORWARD = -4100;
    public static final int BACKWARD = -4101;
}
